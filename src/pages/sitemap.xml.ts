...
const STATIC_PATHS = [
  ...
  { path: '/veiculos', priority: '0.9', changefreq: 'daily' },
  { path: '/veiculos?oferta=true', priority: '0.8', changefreq: 'daily' },
  { path: '/veiculos?repasse=true', priority: '0.7', changefreq: 'daily' },
