...
| **Hospedagem**     | Cloudflare, plano gratuito, conta **lupinho7881@gmail.com** (só este projeto): Workers, D1, KV, Turnstile                                             |
...
| 3   | **Ativar o R2** antes do cadastro do estoque inicial (o KV grátis aceita ~250 fotos de veículo por dia)                                                                                                                                                                                           | Painel Cloudflare → R2 → ativar (pode pedir cartão, sem cobrança dentro do grátis). Depois eu crio o bucket e migro ([passo 7](DEPLOY.md#7-ativar-o-r2-para-as-fotos-recomendado)) | Muito recomendado |
...
| ----------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fotos no KV                   | 1 GB e **1 mil gravações/dia**                | Foto real da loja ≈ 0,8 MB (4 versões): **~1.250 fotos ≈ 100 veículos com 12 fotos** (média atual). Em 25/09 já eram 13 veículos e 154 fotos (~12% do espaço). Vendidos e arquivados ocupam; excluir libera. ~250 fotos enviadas por dia |
| Fotos no R2 (ativar, item B3) | 10 GB e 1 mi gravações/mês                    | ~12.500 fotos ≈ 1.000 veículos com 12 fotos                                                                                                                                                                                              |
...
- Recursos na Cloudflare (conta lupinho7881@gmail.com): Worker `mm-veiculos`, banco D1 `mm-veiculos`, KV
  `mm-veiculos-media` (binding `MEDIA_KV`), widget Turnstile “M&M Veiculos”.
