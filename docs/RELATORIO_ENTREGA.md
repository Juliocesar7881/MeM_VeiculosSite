...
| 4   | **Apagar a cópia antiga** na conta loopsluchini@gmail.com (Worker `mm-veiculos`, D1 `mm-veiculos`, KV `mm-veiculos-media`, widget Turnstile “M&M Veículos”) — **não** apagar `visor-db`, `CALENDAR_KV` nem `visor-crypto-privacy-policy` | Painel da Cloudflare dessa conta                                                                                                                                                   | Recomendado       |
