...
| **Endereço atual** | https://mm-veiculos.visor-crypto.workers.dev (temporário, para validação) · painel em `/admin`                                                        |
...
| 7   | Definir **de quem é a conta Cloudflare**: hoje os recursos estão na conta do desenvolvedor (por isso o endereço `visor-crypto.workers.dev`). Opções: manter e administrar para o cliente, adicionar o cliente como membro, ou recriar na conta da M&M | [DEPLOY.md, passo 11](DEPLOY.md#11-recriar-tudo-em-outra-conta)                                                                                 | Decidir antes da entrega |
