...
| **Buscadores**     | Liberados desde 26/09/2026; site cadastrado no Google Search Console com o sitemap enviado                                                            |
...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| 1   | ✅ **Domínio comprado** (26/09/2026) — **Comprar o domínio** no Registro.br (titular com CPF/CNPJ, de preferência o CNPJ da M&M)                                                                                                                                                                  | registro.br → pesquisar `mmveiculos.com.br` → contratar                                                                                                                      | **Obrigatório**   |
| 2   | ✅ **Feito em 26/09/2026** — **Adicionar o domínio na Cloudflare** (conta lupinho7881) e trocar os nameservers no Registro.br                                                                                                                                                                     | [DEPLOY.md, passo 6](DEPLOY.md#6-domínio-próprio). Depois, rodar `npm run cf:domain -- mmveiculos.com.br` (ou pedir para eu rodar)                                           | **Obrigatório**   |
...
| 6   | ✅ Google Search Console (26/09/2026): verificado, sitemap enviado                                                                                                                                                                                                                                | passo 6                                                                                                                                                                      | Recomendado       |
